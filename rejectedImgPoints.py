...
rejectedImgPoints_y = []
        ...
        vidname = 'ridCalibraiton_box01_20230608_15-51-56_direct_700-1350-1-935.avi'
        good_frames = [260, 261, 262, 263, 264, 265, 266, 267, 268, 269]  # change later
        ...
        for i in range(len(rejectedImgPoints)):
            ...
            for j in range(len(temp_group)):
                ...
                for k in range(len(temp_point)):
                    ...
                    for l in range(len(temp_coord)):  # makes coordinate
                        temp = temp_coord[l]
                        if l == 0:
